...
export function resetPageMeta() {
  ...
  document.title = 'Border Pulse | US-Mexico Border Crossing Wait Reports';
  setMeta('description', 'Official wait reports at US-Mexico border crossings, with regular refreshes and 30-day planning patterns. Bilingual EN/ES.');
  setMeta('og:title', 'Border Pulse | US-Mexico Border Crossing Wait Reports', 'property');
  setMeta('og:description', 'Official wait reports at US-Mexico border crossings, with regular refreshes and 30-day planning patterns. Bilingual EN/ES.', 'property');
